module.exports = (Ember) ->
	...
	templates._contact = require '../../templates/_contact.jade'
	templates._response = require '../../templates/_response.jade'
	templates._hoveruser = require '../../templates/components/_hoveruser.jade'
